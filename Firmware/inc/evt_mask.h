...
#define EVTMSK_DOSE_SAVE            EVENT_MASK(1)
...
#define EVTMSK_UART_NEW_CMD         EVENT_MASK(6)
#define EVTMSK_TYPE_CHANGED         EVENT_MASK(7)
#define EVTMSK_PROLONGED_PILL       EVENT_MASK(8)
#define EVTMSK_AUTODOC_COMPLETED    EVENT_MASK(9)
